...
def test_w7x_chopper(test_type):
    ...
    flap.plot('Beam_on',axes=['Time',1.25],plot_type='scatter')
    legend.append('Beam on')
    flap.plot('Beam_off',axes=['Time',1.3],plot_type='scatter')
    legend.append('Beam off')
    if (test_type == 'camera'):
        flap.plot('Beam_defl',axes=['Time',1.35],plot_type='scatter')
        legend.append('Beam deflected')
    flap.plot('Chop_period',axes=['Time',1.4],plot_type='scatter')
    ...
    legend.append('ABES-20')
    flap.plot('Beam_on',axes=['Sample',1.25],plot_type='scatter')
    legend.append('Beam on')
